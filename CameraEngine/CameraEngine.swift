...
@objcMembers public class CameraEngine: NSObject {
    ...
    private func handleDeviceOrientation() {
        if self.rotationCamera {
          ...
          NotificationCenter.default.addObserver(forName: UIDevice.orientationDidChangeNotification, object: nil, queue: OperationQueue.main) { [weak self] (_) -> Void in
...
public extension CameraEngine {
    ...
    func createGif(_ fileUrl: URL, frames: [UIImage], delayTime: Float, loopCount: Int = 0, completionGif: @escaping blockCompletionGifEncoder) {
